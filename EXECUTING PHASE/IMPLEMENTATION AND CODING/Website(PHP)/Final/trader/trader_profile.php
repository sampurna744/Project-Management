...
<body>
    ...
    <div id="profileDetailsContainer" class="profile-details-container">
        <div class="left-div">
            <img src="../profile_image/<?php echo htmlspecialchars($user_profile_picture); ?>" alt="Profile Picture" class="profile-picture">
        </div>
        <div class="right-div">
            <form id="profileDetailsForm" class="profile-details-form" name="profileDetailsForm" method="POST" action="" enctype="multipart/form-data">
                <div class="form-row">
                    ...
                    <input type="text" id="firstName" name="firstName" class="form-input" placeholder="Enter first name" required value="<?php echo htmlspecialchars($first_name); ?>" pattern="[A-Za-z]+" title="Please enter only alphabetic characters">
                    <?php if (!empty($first_name_error)) echo "<p style='color: red;'>$first_name_error</p>"; ?>
                </div>
                <div class="form-row">
                    <label for="lastName" class="form-label">Last Name:</label>
                    <input type="text" id="lastName" name="lastName" class="form-input" placeholder="Enter last name" required value="<?php echo htmlspecialchars($last_name); ?>" pattern="[A-Za-z]+" title="Please enter only alphabetic characters">
                    <?php if (!empty($last_name_error)) echo "<p style='color: red;'>$last_name_error</p>"; ?>
                </div>
                <div class="form-row">
                    <label for="email" class="form-label">Email:</label>
                    <input type="email" id="email" name="email" class="form-input" placeholder="Enter email" readonly value="<?php echo htmlspecialchars($user_email); ?>">
                </div>
                <div class="form-row">
                    <label for="address" class="form-label">Address:</label>
                    <textarea id="address" name="address" class="form-textarea" rows="4" placeholder="Enter address" required pattern="[A-Za-z0-9, -]+" title="Please enter alphanumeric characters, comma, hyphen, or space only"><?php echo htmlspecialchars($user_address); ?></textarea>
                    <?php if (!empty($address_error)) echo "<p style='color: red;'>$address_error</p>"; ?>
                </div>
                <div class="form-row">
                    <label for="contact" class="form-label">Contact:</label>
                    <input type="tel" id="contact" name="contact" class="form-input" placeholder="Enter contact number" required value="<?php echo htmlspecialchars($user_contact_no); ?>" pattern="[0-9]+" title="Please enter only numeric characters">
                    <?php if (!empty($contact_no_error)) echo "<p style='color: red;'>$contact_no_error</p>"; ?>
                </div>
                <div class="form-row">
                    ...
                    <?php if (!empty($profile_upload_error)) echo "<p style='color: red;'>$profile_upload_error</p>"; ?>
                </div>
                <div class="form-row">
