...
<nav class="navbar">
    <a href="trader_dashboard.php" class="logo"><img src="../CleckFax_Traders_Hub_Logo_group6-removebg-preview.png" alt="logo" class="logo-image"></a>
    <h1 class="heading">Trader Dashboard</h1>
    <div class="user-info">
      <span class="welcome">Welcome,</span>
      <span class="trader-name">
  <?php echo isset($_SESSION["FIRST_NAME"]) ? htmlspecialchars($_SESSION["FIRST_NAME"]) : "Trader"; ?>
</span>
<img src="../profile_image/<?php echo isset($_SESSION["USER_PROFILE_PICTURE"]) ? htmlspecialchars($_SESSION["USER_PROFILE_PICTURE"]) : "default.png"; ?>" alt="Profile Image" class="profile-image">
      <div class="dropdown">
        <ul>
  ...
  <button class="navbar-button" onclick="window.open('http://127.0.0.1:8080/apex/f?p=104:LOGIN_DESKTOP:15514426205272:::::', '_blank'); return false;">
    ...
    <span class="button-text">Oracle Dashboard</span>
</button>
