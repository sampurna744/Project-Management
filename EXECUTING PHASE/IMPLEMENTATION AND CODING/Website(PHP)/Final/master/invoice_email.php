...
function sendInvoiceEmail($order_id, $user_id) {
    ...
    try {
        ...
        // Recipients
        $mail->setFrom('cleckfaxtradershub@gmail.com', 'cleckfaxtradershub');
        ...
        $mail->addReplyTo("cleckfaxtraders@gmail.com", "ckeckfaxtradershub");
        ...
        // Content
        $mail->isHTML(true);
        $mail->Subject = 'Cleckfax Trader Hub INVOICE';
        ...
        <body style='font-family: Arial, sans-serif; text-align: center;'>
            ...
            <!-- Heading -->
            <h2 style='color: #333;'>cleckfaxtraderhub Invoice</h2>
        
            <h3 style='text-align: center; font-size: 20px;'>Thank you <b style='text-transform: uppercase;'>$name</b> for Choosing Cleckfax Trader Hub<br>Here is your Invoice Detail </h3>
        ...
        $mail->Body .= "
            ...
            <p style='text-align: center;'><b>Hope your cart was as full as your heart. Come back soon! cleckfaxtraderhub<b></p>
            ...
            <!--Logo -->
            <img src='C:\xampp\htdocs\newpull\CleckFax_Traders_Hub_Logo_group6-removebg-preview.png' alt='cleckfax Logo' style='width: 100px; height: auto; margin-top: 20px;'>
        </body>
        </html>
        ";
