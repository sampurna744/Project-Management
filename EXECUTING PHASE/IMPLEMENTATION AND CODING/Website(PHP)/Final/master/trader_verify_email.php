...
function sendApprovalEmail($to_email, $name, $shop_id, $trader_id, $SHOP_NAME, $TRADER_TYPE) {
   ...
   $smtp_username = "adhikariroshankumar7@gmail.com"; // Your Gmail address
    $smtp_password = "nbei mnqe qgvp lpcy"; // Your Gmail password Your Gmail password
    ...
    try {
        ...
        $mail->Body    = "
                            ...
                            <body style='font-family: Arial, sans-serif; text-align: center;'>
                                ...
                                <!-- Logo -->
                                <img src='' alt='Cleckfax Traders Logo' style='width: 100px; height: auto; margin-bottom: 20px;'>
